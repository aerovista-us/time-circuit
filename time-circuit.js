(() => {
  ...
  function ensureSampleAudio(){
    ...
    try{
      ...
      sampleLimiter.threshold.value=-1;sampleLimiter.knee.value=0;sampleLimiter.ratio.value=20;sampleLimiter.attack.value=.003;sampleLimiter.release.value=.18;
